...
public class display2 extends javax.swing.JFrame {
     ...
     */
    public display2(String Id, String nAME, String tYPE, String bREED, String gENDER, String birthM, int birthD, int birthY, double wEIGHT, double hEIGHT, String vacM, int vacD, int vacY, String vacId, String tID, String owner, String connum, String ownadd, String ownacc,String validy) {
    ...
    private void initComponents() {
        ...
        jLabel33.setText("<html><div style='text-align: left'>This license might had been invalidate due to some issues.<br><br>Please visit the office if you have some questions. <br><br>THANK YOU!</div> </html>\n");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                String ownacc=null;
                String validy = null;
                new display2(Id,nAME, tYPE, bREED, gENDER, birthM, birthD,birthY, wEIGHT, hEIGHT, vacM, vacD, vacY, vacId,tID, owner, connum, ownadd, ownacc,validy).setVisible(true);
            }
        });
    }
